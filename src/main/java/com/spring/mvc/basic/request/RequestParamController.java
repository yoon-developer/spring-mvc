...
import com.spring.mvc.basic.HelloData;
...
public class RequestParamController {
  ...
  /**
   * @ModelAttribute 사용 참고: model.addAttribute(helloData) 코드도 함께 자동 적용
   */
  @ResponseBody
  ...
  /**
   * @ModelAttribute 생략 가능 String, int 같은 단순 타입 = @RequestParam argument resolver 로 지정해둔 타입 외 =
   * @ModelAttribute
   */
  @ResponseBody
